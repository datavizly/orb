...
module.exports.PivotButton = react.createClass({
    ...
    onFilterMouseDown: function (e) {
        ...
        var filterButton = ReactDOM(this.refs.filterButton);
        ...
        return <div key={self.props.field.name}
            ...
            <table>
                ...
                <tr>
                    ...
                    <td className="filter">
                        <div ref="filterButton" className={filterClass}
                             onMouseDown={self.state.dragging ? null : this.onFilterMouseDown}></div>
                    </td>
                </tr>
                </tbody>
            </table>

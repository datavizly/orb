...
module.exports.PivotCell = react.createClass({
    ...
    render: function () {
                    ...
                    divcontent.push(<table key="header-value" ref="cellContent">
                        ...
                        <tr>
                            <td className="orb-tgl-btn">
                                <div className={'orb-tgl-btn-' + (isWrapper ? 'down' : 'right')}
                                     onClick={(isWrapper ? this.collapse : this.expand)}></div>
                            </td>
        ...
        if (!headerPushed) {
            ...
            divcontent.push(<div key="cell-value" ref="cellContent" className={headerClassName}>
